...
- **All Hands on Deck:** intro line + 1 to 4 items { icon, lead-in, text }
...
- All Hands on Deck: 1 to 4 items (max raised from 3 in July 2026). The block fills its
  vertical space at any count. Horizontal
